...
// 左侧栏的「agent 列表」：每个工作台 = 一个 agent
export const AGENTS: AgentMeta[] = [
  { view: 'image', name: '文生图 Agent', sub: '文本生成图像 · 提示词工程', icon: ImageIcon },
  { view: 'model3d', name: '3D 资产 Agent', sub: '文本 / 图片生成 3D 模型', icon: Boxes },
  { view: 'video', name: '短视频 Agent', sub: '分镜到成片 · 多步编排', icon: Film },
  { view: 'podcast', name: '播客 Agent', sub: '脚本到语音 · 音频合成', icon: Mic },
  { view: 'chat', name: 'Qwen3 Agent', sub: '本地化全模态对话', icon: MessageSquare },
]
